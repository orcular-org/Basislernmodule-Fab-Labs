...
Інші базові навчальні модулі стосуються [3D-моделювання CAD](../1_1_3D_design/UA_3D_дизайн.md), [3D-сканування]((../1_2_3D_scanning/UA_3D_сканування.md)) та [завантаження моделей з веб-сайтів](../1_3_Using_3D_models_from_the_internet/UA_Використання_3D-моделей_з_Інтернету.md).
